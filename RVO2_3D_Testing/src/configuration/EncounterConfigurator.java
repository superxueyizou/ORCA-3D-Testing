...
public class EncounterConfigurator extends JDialog  
{
	...
	public EncounterConfigurator(String intruderAlias) 
	{
		...
		
		{
			...
			CAPVySlider.setMaximum(2);
			CAPVySlider.setMinimum(-10);
